...
public class MockUsers {
  private static List<UserModel> mockUsers = new ArrayList<>(Arrays.asList(
    new UserModel(0, "John", "Reed", "john1994", "19.10.1994", "john1994@gmail.com", "123456", "USER",
      new ArrayList<>(Arrays.asList(MockSurveys.getMockUserSurveysList().get(0))), null, new ArrayList<>(Arrays.asList(MockSurveys.getMockUserSurveysList().get(1)))),
    ...
    new UserModel(2, "David", "Schwimmer", "schwimmy", "31.10.1990", "d.schwimmer@gmail.com", "lalala", "USER", null, null, null)
  ));
