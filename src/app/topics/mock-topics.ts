...
const a3: Array<AnswerModel> = [
  new AnswerModel('none'),
  new AnswerModel('one'),
  new AnswerModel('two'),
  new AnswerModel('more than two')
];
const a4: Array<AnswerModel> = [
  new AnswerModel('melted coffee'),
  new AnswerModel('grained coffee'),
  new AnswerModel('both')
];
...
const q2: Array<QuestionModel> = [
  ...
  new QuestionModel('I take coffee with...spoon of sugar', 'single-choice', a3),
  new QuestionModel('I drink...', 'multiple-choice', a4)
];
